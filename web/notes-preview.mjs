 ...
 *
 * Do not window the DOM on scroll. Changing padTop/from while restoring
 * keepTop fights the scroller (preview jitters and cannot move down).
 * Long notes were 25k blocks only because nested <<<<<<<; that is flattened.
 */
