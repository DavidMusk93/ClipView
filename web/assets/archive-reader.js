...
(function () {
  ...
  function injectCSS() {
    ...
    css.textContent = [
      ...
      "border-radius:14px;border:.5px solid rgba(60,60,67,.12);",
      "box-shadow:0 10px 28px rgba(0,0,0,.16),0 0 0 .5px rgba(255,255,255,.4) inset;}",
      ...
      ".cv-note-lead{display:flex;align-items:center;gap:7px;min-width:0;height:28px;flex:1;}",
      ".cv-note .cv-note-head strong{display:block;font-size:13px;font-weight:600;letter-spacing:-.02em;line-height:28px;height:28px;flex-shrink:0;transform:translateY(2px);}",
      ".cv-note .cv-quote-bar{width:2px;height:13px;border-radius:1px;background:#ffd60a;flex-shrink:0;}",
      ".cv-note .cv-quote{display:block;font-size:13px;line-height:28px;height:28px;color:#6e6e73;letter-spacing:-.01em;margin:0;",
      "overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;flex:1 1 0;transform:translateY(2px);}",
      ...
      "display:block;font:inherit;font-size:13px;font-weight:590;letter-spacing:-.016em;line-height:28px;}",
