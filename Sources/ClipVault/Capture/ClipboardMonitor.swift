...
class ClipboardMonitor: ObservableObject {
    ...
    private let monitorQueue = DispatchQueue(label: "com.clipvault.monitor", qos: .userInitiated)
    private let ocrQueue = DispatchQueue(label: "com.clipvault.strip-ocr", qos: .utility)
