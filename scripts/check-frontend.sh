...
echo "[check-frontend] node --test frontend smoke + notes/masonry/pagination + archive view/reader + clip-link + url-safety + sse-control + search-judgment + notes-editor + notes-calc + ui-metrics + compose + share-links"
node --test tests/frontend-smoke.test.mjs tests/notes-render.test.mjs tests/masonry.test.mjs tests/pagination.test.mjs tests/archive-view.test.mjs tests/archive-reader.test.mjs tests/clip-link.test.mjs tests/url-safety.test.mjs tests/sse-control.test.mjs tests/search-judgment.test.mjs tests/notes-editor.test.mjs tests/notes-calc.test.mjs tests/ui-metrics.test.mjs tests/compose.test.mjs tests/share-links.test.mjs
